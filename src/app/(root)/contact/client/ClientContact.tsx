    ...
    <section>
      <div className="container mx-auto mt-[80px] flex flex-col justify-between gap-10 px-5 pt-5 lg:px-20 xl:flex-row">
        <div className="xl:w-[40%]">
          ...
          <Link
            href="mailto:orbitmatrix.work@gmail.com"
          ...
          <div className="mb-6 flex flex-col gap-4 md:flex-row">
            <div className="w-full">
              ...
              <input
                ...
                required
                className="mt-4 w-full bg-[#000000] py-[28px] pl-[24px] pr-[12px] text-[#f1f1f1] outline-none md:py-[20px]"
          ...
          <div className="mb-6 w-full ">
            ...
            <div className="relative mt-4 flex w-full items-center ">
              ...
              <select
                ...
                aria-label="budget"
                required
                className="w-full bg-[#000000] py-[28px] pl-[32px] pr-[24px] text-[#666] outline-none md:py-[20px]"
